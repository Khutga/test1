...
class _LiveViewScreenState extends State<LiveViewScreen> {
  ...
  void _handleSendGift(String giftType) {
    ...
    // 3.5 saniye sonra efekti kaldır
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.black, // Video arkası genelde siyah olur
      body: Stack(
        children: [
          // 1. Video Katmanı (Şimdilik placeholder)
          Center(
            child: Column(
          ...
          // 5. Hediye Efekti Overlay (En üstte)
          if (_giftEffect != null)
            Positioned.fill(
              child: Container(
