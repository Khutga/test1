            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text("FiFi Live", style: TextStyle(fontSize: 26, fontWeight: FontWeight.w900, fontStyle: FontStyle.italic, color: AppColors.primaryPink, letterSpacing: -0.5)),
                    Row(
                      children: [
                        GlassIconButton(icon: LucideIcons.search, onTap: () {}),
                        const SizedBox(width: 12),
                        GlassIconButton(icon: LucideIcons.zap, color: Colors.amber, onTap: () {}),
                      ],
                    )
                  ],
                ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    GlassTabButton(label: 'Təqib', isActive: _subTab == 'takip', onTap: () => setState(() => _subTab = 'takip')),
