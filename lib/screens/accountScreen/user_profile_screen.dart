...
import 'package:nivi/screens/accountScreen/follow_list_screen.dart';
...
class _UserProfileScreenState extends State<UserProfileScreen> {
  ...
  Future<void> _fetchUserData() async {
    ...
    final res = await SqlServis.cek(
      tablo: 'hesaplar',
      sartlar: {'isim': widget.hedefKullaniciAdi},
    );
                  ...
                  children: [
                    GestureDetector(
                      onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              FollowListScreen(initialTab: 'followers'),
                        ),
                      ),
                    ...
                    GestureDetector(
                      onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              FollowListScreen(initialTab: 'following'),
                        ),
                      ),
                      child: _buildStatItem(
                        context,
