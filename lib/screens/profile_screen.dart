      ...
      body: MainBackground(
        child: SafeArea(
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                const GlowAvatar(initial: "A", radius: 44, color: AppColors.primaryPurple),
                const SizedBox(height: 16),
                
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    const Text("Alexander", style: TextStyle(fontSize: 26, fontWeight: FontWeight.w900, letterSpacing: 0.5)),
                ...
                const Text("Müzik, Kodlama ve Kahve. ☕️\nİstanbul ♍️ Başak Erkeği", textAlign: TextAlign.center, style: TextStyle(color: AppColors.textGray, fontSize: 13, height: 1.4)),
                const SizedBox(height: 32),
                
                GlassContainer(
                  padding: const EdgeInsets.all(20),
                  gradientColors: [AppColors.primaryPurple.withOpacity(0.2), AppColors.primaryPink.withOpacity(0.1)],
                  child: Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const CoinShopScreen())),
                        ...
                        child: const Text("Yükle", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14)),
                      )
                    ],
                  ),
                ),
                ...
                MenuActionTile(
                  icon: LucideIcons.activity, label: "Ajans Sistemi & Paneli", iconColor: Colors.greenAccent, badge: "VIP",
